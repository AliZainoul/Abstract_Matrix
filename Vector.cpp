...
// Show Function
void Vector::affiche(){
  cout << "Taille du vecteur: "<< M_size<< endl;
  for(int i=0; i<M_size; i++)
	cout <<"Indice: "<< i <<", Valeur: " << M_data[i]<<endl;
}
